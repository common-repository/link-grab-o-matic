...
1. Upload the `link-grab-o-matic` folder to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Click the new 'Link Grab-o-Matic' option under the Posts menu from your admin screen
1. Rock on!

== Frequently Asked Questions ==
You haven't asked any yet, but when you do and they become frequent, I'll put them here.
...
* added options screen under settings to allow for better user defined preferences

== Upgrade Notice ==

= 1.1 =
has fixed two large issues with how the plugin worked due to some path issues.



== Arbitrary section ==

Something should maybe go here? 
